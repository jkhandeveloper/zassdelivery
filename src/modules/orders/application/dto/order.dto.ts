...
const CUSTOMER_PAYMENT_METHODS = [PaymentMethod.CASH_ON_DELIVERY, PaymentMethod.WALLET] as const;
...
export class PlaceOrderDto {
  @ApiProperty({
    ...
    description:
      'Card and mobile-wallet gateways arrive with the Payments module; only ' +
      'cash on delivery and the in-app wallet are settled today.',
  })
  @IsOptional()
